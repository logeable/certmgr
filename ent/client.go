...
// QueryCertificates queries the certificates edge of a Namespace.
func (c *NamespaceClient) QueryCertificates(n *Namespace) *CertificateQuery {
...
type (
	hooks struct {
		Certificate, Namespace []ent.Hook
	}
	inters struct {
		Certificate, Namespace []ent.Interceptor
	}
)
